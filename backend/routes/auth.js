...
// Route 2: Authenticate an existing user to login: http://localhost:5000/api/auth/userlogin
router.post(
  "/userlogin",
  [
...
// Route 3: Get details of logged-in user using POST: http://localhost:5000/api/auth/logindetails
